...
print("🚀 Starte Raw-KI Test (FARBE)...")
...
def generate_frames():
    while True:
        ...
        # ÄNDERUNG: Wir holen das Originalbild (Farbe/BGR) statt Gray
        ...
        # 2. ÄNDERUNG: BGR zu RGB (statt Gray-Stacking)
        # Das Modell wurde mit RGB Bildern trainiert
        ...
        # --- VISUALISIERUNG ---
        # ÄNDERUNG: Frame ist schon BGR, wir kopieren es nur, um drauf zu malen
        preview = frame.copy()
...
if __name__ == '__main__':
    try:
        print("🎥 Raw-KI Stream (FARBE) läuft auf Port 5000")
